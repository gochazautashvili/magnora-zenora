...
export const passwordComplexityValidator: ValidatorFn = (control: AbstractControl) => {
...
export const passwordMatchValidator: ValidationErrors = (group: AbstractControl)  => {
